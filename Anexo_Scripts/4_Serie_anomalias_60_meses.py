...
ifile="anomalias_tipo_1_anms.nc" # Abajo se usarán los nombres de la variable de interés (temperatura = Temp2m ) y de la variable tiempo (fechas = time)
...
plt.title("Anomalía de temperatura respecto al ciclo anual - Área 1")
...
plt.xticks(mons2, mons2, rotation='vertical')
plt.ylabel("Temperatura (°C)")
plt.title("Anomalía de temperatura respecto al ciclo anual - Área 2")
...
plt.xticks(mons2, mons2, rotation='vertical')
plt.ylabel("Temperatura (°C)")
plt.title("Anomalía de temperatura respecto al ciclo anual - Área combinada")
